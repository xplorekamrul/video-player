  ...
  return (
    <TooltipProvider delayDuration={isFullscreen ? 100 : 300}>
      ...
      >
        <div
          className={cn(
            "px-2 sm:px-4 pb-1 sm:pb-2 transition-all duration-500 ease-out",
            isFullscreen && "px-4 sm:px-6 pb-2"
          )}
        >
          <span
              className={cn(
          ...
          <div
            ref={progressRef}
            className={cn(
              "relative bg-white/20 rounded-full cursor-pointer group transition-all duration-300 ease-out h-[4px] sm:h-[6px] md:h-[6px]",
              "hover:h-[6px] sm:hover:h-[8px] hover:bg-white/30"
            )}
            onClick={handleProgressClick}
            onMouseMove={handleProgressMouseMove}
            onMouseLeave={handleProgressMouseLeave}
          ...
          >
            ...
            {previewTime !== null && duration > 0 && (
              <div
                className={cn(
                  "absolute bottom-full mb-2 sm:mb-3 px-3 sm:px-4 py-1 sm:py-2 bg-black/90 text-white rounded-lg whitespace-nowrap backdrop-blur-md border border-white/20",
                  isFullscreen && "text-base sm:text-lg px-5 sm:px-6 py-2 sm:py-3"
                )}
                style={{
                  left: `calc(${(previewTime / duration) * 100}% - 40px)`,
                  transform: "translateX(-50%)",
        ...
        <div
          className={cn(
            "flex flex-wrap items-center justify-between gap-2 sm:gap-4 transition-all duration-500 ease-out",
            "bg-gradient-to-t from-black/80 via-black/50 to-transparent",
            "backdrop-blur-md border-t border-white/20 px-2 sm:px-4 py-2 sm:py-3",
            "min-w-[320px]"
          )}
        >
                ...
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={cn(
                      "text-white hover:bg-white/20 transition-all duration-200 border border-white/20 backdrop-blur-md",
                      (!canGoPrevious || isNavigating) && "opacity-50 cursor-not-allowed",
                      isFullscreen && "px-4 sm:px-5 py-2 sm:py-3",
                      isNavigating && "animate-pulse",
                      "p-2 sm:p-3"
                    )}
                    aria-label="Previous video in playlist"
                  >
                    <SkipBack className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  {getTooltipContent("Previous video")}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className={cn("text-white hover:bg-white/20 transition-all duration-200", "p-2 sm:p-3")}
                  aria-label={isPlaying ? "Pause" : "Play"}
                  aria-pressed={isPlaying}
                >
                  {isPlaying ? (
                    <Pause className={cn("h-5 w-5 sm:h-6 sm:w-6")} />
                  ) : (
                    <Play className={cn("h-5 w-5 sm:h-6 sm:w-6")} />
                  )}
                </Button>
              </TooltipTrigger>
              <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    aria-label="Next video in playlist"
                  >
                    <SkipForward className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  {getTooltipContent("Next video")}
          ...
          <div className="flex items-center space-x-1 sm:space-x-3 flex-wrap">
            {/* Three-dot menu button for small screens */}
            <div className="md:hidden relative" ref={menuRef}>
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    <MoreVertical className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  {getTooltipContent("Menu")}
                </TooltipContent>
              </Tooltip>
              ...
              {isMenuOpen && (
                <div
                  className={cn(
                    "absolute right-0 bottom-full mb-2 bg-black/90 backdrop-blur-md border border-white/20 rounded-lg p-4 flex flex-col gap-4",
                    "w-48 sm:w-64 h-[150px] overflow-y-auto z-[9999]"
                  )}
                >
                  <div
                  ...
                  >
                    <Tooltip>
                      <TooltipTrigger asChild>
                        ...
                        >
                          {isMuted || volume === 0 ? (
                            <VolumeX className={cn("h-4 w-4")} />
                          ) : (
                            <Volume2 className={cn("h-4 w-4")} />
                          )}
                        </Button>
                      </TooltipTrigger>
                      <TooltipContent>
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        "transition-all duration-300 ease-out overflow-hidden",
                        showBrightnessSlider ? "w-24 opacity-100" : "w-0 opacity-0"
                      )}
                    >
                      <Slider
                        value={[brightness]}
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                          ...
                          className={cn(
                            "text-white hover:bg-white/20 transition-all duration-200",
                            "p-2 w-full justify-start"
                          )}
                          aria-label="Open playlist"
                        >
                          <List className={cn("h-4 w-4 mr-2")} />
                          Playlist
                        </Button>
                      </TooltipTrigger>
                      <TooltipContent>
            ...
            {/* Controls visible on medium screens and above */}
            <div className="hidden md:flex items-center space-x-1 sm:space-x-3 flex-wrap">
              <div
                className="relative flex items-center group"
                onMouseEnter={handleVolumeSliderShow}
                onMouseLeave={handleVolumeSliderHide}
                ...
                <div className="flex items-center space-x-1 sm:space-x-3">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        {isMuted || volume === 0 ? (
                          <VolumeX className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                        ) : (
                          <Volume2 className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                        )}
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>
              ...
              >
                <div className="flex items-center space-x-1 sm:space-x-3">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        onClick={handleControlClick}
                      >
                        <Sun className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>
                      {getTooltipContent("Brightness", `${brightness}%`)}
                  ...
                  <div
                    className={cn(
                      "transition-all duration-300 ease-out overflow-hidden",
                      showBrightnessSlider ? "w-20 sm:w-24 md:w-32 opacity-100" : "w-0 opacity-0"
                    )}
                  >
                    <Slider
                      value={[brightness]}
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    aria-label="Open settings"
                  >
                    <Settings className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  {getTooltipContent("Settings")}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  aria-pressed={isPiP}
                >
                  <PictureInPicture className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                </Button>
              </TooltipTrigger>
              <TooltipContent>
                {getTooltipContent("Picture in Picture")}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  aria-pressed={theaterMode}
                >
                  <Monitor className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                </Button>
              </TooltipTrigger>
              <TooltipContent>
                {getTooltipContent("Theater mode")}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  {isFullscreen ? (
                    <Minimize className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  ) : (
                    <Maximize className={cn("h-4 w-4 sm:h-5 sm:w-5")} />
                  )}
                </Button>
              </TooltipTrigger>
              <TooltipContent>
